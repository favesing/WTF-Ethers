...
addressWETH = '0xb16F35c0Ae2912430DAc15764477E179D9B9EbEa'
// 声明合约实例
...
const main = async () => {
    ...
    console.log(`合约名: ${await contract.name()}`)
    console.log(`当前区块高度: ${block}`);
    console.log(`打印事件详情:`);
    const transferEvents = await contract.queryFilter('Transfer', 9285395, 9285395+10)
    ...
    const len = transferEvents.length;
    console.log(`\n2. 解析事件：${len} 个Transfer事件中的第1个`)
    if(len > 0){
